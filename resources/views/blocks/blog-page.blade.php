<div class="{{ $block->classes }}">
  {{-- @dump($blog)
  @dump($studies) --}}
  <div class="container px-4 mx-auto my-8 sm:px-6 lg:px-8 md:my-12 lg:my-24">
    <div class="md:flex md:items-center md:space-x-12 lg:space-x-16 xl:max-w-5xl xl:mx-auto 2xl:max-w-7xl">
      <h2 class="mb-4 text-4xl font-bold font-poppins lg:text-5xl xl:text-6xl">{!! $b_title !!}</h2>
    ...
    <div class="relative blog-slider swiper-container">
      <div class="swiper-wrapper">
        ...
        @foreach($blog as $post)
          @if($loop->index % 5 == 0 )
            <div class="grid grid-col-1 swiper-slide blog-grid gap-y-4 md:grid-cols-8 md:gap-y-0 md:grid-rows-5">
          @endif
  ...
  <div class="container px-4 mx-auto my-12 sm:px-6 lg:px-8 md:my-12 lg:my-24">
    <div class="md:flex md:items-center md:space-x-12 lg:space-x-16 xl:max-w-5xl xl:mx-auto 2xl:max-w-7xl">
      <h2 class="mb-4 text-4xl font-bold font-poppins lg:text-5xl xl:text-6xl">{!! $s_title !!}</h2>
      <div class="prose text-black lg:prose-lg max-w-none">
        {!! $s_content !!}
      </div>
    </div>
    ...
    <div class="relative study-slider swiper-container">
      <div class="swiper-wrapper">
        ...
        @foreach($studies as $post)
          ...
          @endif
          @if($loop->index % 3 == 0 )
            <div class="study-row md:grid md:grid-cols-3 md:gap-6 lg:gap-8 2xl:gap-12">
          @endif
